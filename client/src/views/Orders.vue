<template>
  <div class="orders">
    ...
    <div v-else>
      <div v-if="!restockingLoading && restockingOrders.length > 0" class="card">
...
export default {
  ...
  setup() {
    ...
    // Independent load state for restocking orders - does not interfere with
    // the main orders table's load/filter logic.
